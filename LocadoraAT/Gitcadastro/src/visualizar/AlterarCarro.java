...
public class AlterarCarro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Alterar informaﾃｧﾃｵes do veﾃｭculo ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Yu Gothic UI Semilight", 3, 18), new java.awt.Color(51, 51, 51))); // NOI18N
        jPanel1.setLayout(null);

        lblCD.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 14)); // NOI18N
        lblCD.setText("Cﾃｳdigo do Veﾃｭculo:");
        jPanel1.add(lblCD);
        lblCD.setBounds(20, 70, 140, 30);

        CaixaCD.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<Cﾃｳdigo do Veﾃｭculo>" }));
        ...
        lblNV1.setText("Nome do veﾃｭculo:");
        jPanel1.add(lblNV1);
        ...
        jLabel2.setText("Valor do veﾃｭculo:");
        jPanel1.add(jLabel2);
        ...
        jLabel3.setText("Ano do veﾃｭculo:");
        jPanel1.add(jLabel3);
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        if (CaixaCD.getSelectedItem().equals("<Cﾃｳdigo do Veﾃｭculo>")) {
            JOptionPane.showMessageDialog(null, "Opﾃｧﾃ｣o Errada, escolha uma das opﾃｧﾃｵes abaixo !", null, WIDTH);
        } else {
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if (CaixaCD.getSelectedItem().equals("<Código do Veﾃｭculo>")) {
            JOptionPane.showMessageDialog(null, "Opção Errada, escolha uma das opcões abaixo !", null, WIDTH);
        } else {
