...
public class DAO extends Veiculos {
    ...
    public void cadastrarVeiculo(Veiculos veiculo) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro em cadastrar veiculo " + e.getMessage());
        }
    }
    ...
    public void alterarVeiculo(Integer codVeiculo, Veiculos veiculo) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Erro em alterar veiculo " + e.getMessage());
        }
    }
    ...
    public void calcularMediaValores() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "A media de valores de " + tamanhoLista + " é de: R$" + media);
        } catch (Exception e) {
