...
public class AlterarCarro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Alterar informa�ｾ�ｽｧ�ｾ�ｽｵes do ve�ｾ�ｽｭculo ", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Yu Gothic UI Semilight", 3, 18), new java.awt.Color(51, 51, 51))); // NOI18N
        jPanel1.setLayout(null);

        lblCD.setFont(new java.awt.Font("Yu Gothic UI Semilight", 1, 14)); // NOI18N
        lblCD.setText("C�ｾ�ｽｳdigo do Ve�ｾ�ｽｭculo:");
        jPanel1.add(lblCD);
        lblCD.setBounds(20, 70, 140, 30);

        CaixaCD.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<C�ｾ�ｽｳdigo do Ve�ｾ�ｽｭculo>" }));
        ...
        lblNV1.setText("Nome do ve�ｾ�ｽｭculo:");
        jPanel1.add(lblNV1);
        ...
        jLabel2.setText("Valor do ve�ｾ�ｽｭculo:");
        jPanel1.add(jLabel2);
        ...
        jLabel3.setText("Ano do ve�ｾ�ｽｭculo:");
        jPanel1.add(jLabel3);
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        ...
        if (CaixaCD.getSelectedItem().equals("<C�ｾ�ｽｳdigo do Ve�ｾ�ｽｭculo>")) {
            JOptionPane.showMessageDialog(null, "Op�ｾ�ｽｧ�ｾ�ｽ｣o Errada, escolha uma das op�ｾ�ｽｧ�ｾ�ｽｵes abaixo !", null, WIDTH);
        } else {
    ...
    private void btnAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAlterarActionPerformed
        ...
        if (CaixaCD.getSelectedItem().equals("<Cﾃｳdigo do Ve�ｾ�ｽｭculo>")) {
            JOptionPane.showMessageDialog(null, "Opﾃｧﾃ｣o Errada, escolha uma das opcﾃｵes abaixo !", null, WIDTH);
        } else {
