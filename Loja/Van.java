...
public Van(String plac,double pot,String modelo,String cor,String marca,boolean cambio_automatico,int ano) {
	placa=plac;
	potencia=pot;
...
public static void main(String[] args) {
	...
	Van C1 = new Van("FDG6980",2.0, "modelo", "cinza0", "Ferrari",true, 2020);
	...
	Van C2;
	C2 =new Van("USA2000",1.0,"palio","preto","fiat",false, 2012);
